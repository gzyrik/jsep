...
#ifndef WEBRTC_AUDIO_DEVICE_AUDIO_DEVICE_EXTERNAL_H
#define WEBRTC_AUDIO_DEVICE_AUDIO_DEVICE_EXTERNAL_H
...
class AudioDeviceModuleExternal : public AudioDeviceModule {
 public:
  enum PlatformType {
  ...
  AudioDeviceModuleExternal(const int32_t id, const AudioLayer audioLayer);
  ~AudioDeviceModuleExternal() override;
 ...
 private:
  int32_t CreatePlatformSpecificObjects(const char* deviceName = nullptr);
...
#endif  // WEBRTC_MODULES_INTERFACE_AUDIO_DEVICE_EXTERNAL_H_
