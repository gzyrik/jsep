...
#include <assert.h>
#include <string.h>
#define WEBRTC_ZMF_AUDIO_BUILD
#if defined(WEBRTC_ZMF_AUDIO_BUILD)
...
rtc::scoped_refptr<AudioDeviceModule> AudioDeviceModuleExternal::Create(
    const int32_t id,
    const char* deviceName) {
  LOG(INFO) << __FUNCTION__;
  // Create the generic ref counted (platform independent) implementation.
  rtc::scoped_refptr<AudioDeviceModuleExternal> audioDevice(
      new rtc::RefCountedObject<AudioDeviceModuleExternal>(id, AudioLayer::kPlatformDefaultAudio));
  ...
  if (audioDevice->CreatePlatformSpecificObjects(deviceName) == -1) {
    return nullptr;
  }
...
// ----------------------------------------------------------------------------
//  AudioDeviceModuleExternal - ctor
// ----------------------------------------------------------------------------

AudioDeviceModuleExternal::AudioDeviceModuleExternal(const int32_t id,
...
int32_t AudioDeviceModuleExternal::CheckPlatform() {
  LOG(INFO) << __FUNCTION__;
...
int32_t AudioDeviceModuleExternal::CreatePlatformSpecificObjects(const char* deviceName) {
  LOG(INFO) << __FUNCTION__;


#if defined(WEBRTC_ZMF_AUDIO_BUILD)
  AudioDeviceZmf * ptrAudioDevice = new AudioDeviceZmf(Id(),deviceName);
  LOG(INFO) << "Zmf Audio APIs will be utilized";
...
//
  ...
  return 0;
#endif // if defined(WEBRTC_ZMF_AUDIO_BUILD)
}
...
int32_t AudioDeviceModuleExternal::AttachAudioBuffer() {
  LOG(INFO) << __FUNCTION__;
...
// ----------------------------------------------------------------------------
//  ~AudioDeviceModuleExternal - dtor
// ----------------------------------------------------------------------------

AudioDeviceModuleExternal::~AudioDeviceModuleExternal() {
  LOG(INFO) << __FUNCTION__;
  if (_ptrAudioDevice) {
...
int64_t AudioDeviceModuleExternal::TimeUntilNextProcess() {
...
void AudioDeviceModuleExternal::Process() {
  _lastProcessTime = rtc::TimeMillis();
...
int32_t AudioDeviceModuleExternal::ActiveAudioLayer(AudioLayer* audioLayer) const {
  LOG(INFO) << __FUNCTION__;
...
AudioDeviceModule::ErrorCode AudioDeviceModuleExternal::LastError() const {
  LOG(INFO) << __FUNCTION__;
  return _lastError;
}
...
int32_t AudioDeviceModuleExternal::Init() {
  LOG(INFO) << __FUNCTION__;
  if (_initialized)
    return 0;
...
int32_t AudioDeviceModuleExternal::Terminate() {
  LOG(INFO) << __FUNCTION__;
  if (!_initialized)
    return 0;
...
bool AudioDeviceModuleExternal::Initialized() const {
...
int32_t AudioDeviceModuleExternal::InitSpeaker() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::InitMicrophone() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SpeakerVolumeIsAvailable(bool* available) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetSpeakerVolume(uint32_t volume) {
...
int32_t AudioDeviceModuleExternal::SpeakerVolume(uint32_t* volume) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetWaveOutVolume(uint16_t volumeLeft,
...
int32_t AudioDeviceModuleExternal::WaveOutVolume(uint16_t* volumeLeft,
...
bool AudioDeviceModuleExternal::SpeakerIsInitialized() const {
  LOG(INFO) << __FUNCTION__;
...
bool AudioDeviceModuleExternal::MicrophoneIsInitialized() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::MaxSpeakerVolume(uint32_t* maxVolume) const {
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MinSpeakerVolume(uint32_t* minVolume) const {
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SpeakerVolumeStepSize(uint16_t* stepSize) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SpeakerMuteIsAvailable(bool* available) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetSpeakerMute(bool enable) {
...
int32_t AudioDeviceModuleExternal::SpeakerMute(bool* enabled) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MicrophoneMuteIsAvailable(bool* available) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetMicrophoneMute(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MicrophoneMute(bool* enabled) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MicrophoneBoostIsAvailable(bool* available) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetMicrophoneBoost(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MicrophoneBoost(bool* enabled) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MicrophoneVolumeIsAvailable(bool* available) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetMicrophoneVolume(uint32_t volume) {
  LOG(INFO) << __FUNCTION__ << "(" << volume << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MicrophoneVolume(uint32_t* volume) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::StereoRecordingIsAvailable(
...
int32_t AudioDeviceModuleExternal::SetStereoRecording(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::StereoRecording(bool* enabled) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetRecordingChannel(const ChannelType channel) {
...
int32_t AudioDeviceModuleExternal::RecordingChannel(ChannelType* channel) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::StereoPlayoutIsAvailable(bool* available) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetStereoPlayout(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::StereoPlayout(bool* enabled) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetAGC(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
bool AudioDeviceModuleExternal::AGC() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::PlayoutIsAvailable(bool* available) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::RecordingIsAvailable(bool* available) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MaxMicrophoneVolume(uint32_t* maxVolume) const {
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MinMicrophoneVolume(uint32_t* minVolume) const {
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::MicrophoneVolumeStepSize(
...
int16_t AudioDeviceModuleExternal::PlayoutDevices() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetPlayoutDevice(uint16_t index) {
...
int32_t AudioDeviceModuleExternal::SetPlayoutDevice(WindowsDeviceType device) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::PlayoutDeviceName(
    uint16_t index,
...
int32_t AudioDeviceModuleExternal::RecordingDeviceName(
    uint16_t index,
    char name[kAdmMaxDeviceNameSize],
    char guid[kAdmMaxGuidSize]) {
  LOG(INFO) << __FUNCTION__ << "(" << index << ", ...)";
...
int16_t AudioDeviceModuleExternal::RecordingDevices() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetRecordingDevice(uint16_t index) {
  LOG(INFO) << __FUNCTION__ << "(" << index << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetRecordingDevice(WindowsDeviceType device) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::InitPlayout() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::InitRecording() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
bool AudioDeviceModuleExternal::PlayoutIsInitialized() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
bool AudioDeviceModuleExternal::RecordingIsInitialized() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::StartPlayout() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
  if (Playing()) {
    return 0;
...
int32_t AudioDeviceModuleExternal::StopPlayout() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
bool AudioDeviceModuleExternal::Playing() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::StartRecording() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
  if (Recording()) {
    return 0;
...
int32_t AudioDeviceModuleExternal::StopRecording() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
bool AudioDeviceModuleExternal::Recording() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::RegisterEventObserver(
...
int32_t AudioDeviceModuleExternal::RegisterAudioCallback(
...
int32_t AudioDeviceModuleExternal::StartRawInputFileRecording(
...
int32_t AudioDeviceModuleExternal::StopRawInputFileRecording() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::StartRawOutputFileRecording(
    const char pcmFileNameUTF8[kAdmMaxFileNameSize]) {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::StopRawOutputFileRecording() {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetPlayoutBuffer(const BufferType type,
                                                uint16_t sizeMS) {
...
int32_t AudioDeviceModuleExternal::PlayoutBuffer(BufferType* type,
...
int32_t AudioDeviceModuleExternal::PlayoutDelay(uint16_t* delayMS) const {
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::RecordingDelay(uint16_t* delayMS) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::CPULoad(uint16_t* load) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::SetRecordingSampleRate(
...
int32_t AudioDeviceModuleExternal::RecordingSampleRate(
...
int32_t AudioDeviceModuleExternal::SetPlayoutSampleRate(
    const uint32_t samplesPerSec) {
  LOG(INFO) << __FUNCTION__ << "(" << samplesPerSec << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::PlayoutSampleRate(
    uint32_t* samplesPerSec) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::ResetAudioDevice() {
  LOG(INFO) << __FUNCTION__;
...
int32_t AudioDeviceModuleExternal::SetLoudspeakerStatus(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
int32_t AudioDeviceModuleExternal::GetLoudspeakerStatus(bool* enabled) const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED();
  int32_t ok = 0;
...
bool AudioDeviceModuleExternal::BuiltInAECIsAvailable() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::EnableBuiltInAEC(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
bool AudioDeviceModuleExternal::BuiltInAGCIsAvailable() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::EnableBuiltInAGC(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
bool AudioDeviceModuleExternal::BuiltInNSIsAvailable() const {
  LOG(INFO) << __FUNCTION__;
  CHECK_INITIALIZED_BOOL();
...
int32_t AudioDeviceModuleExternal::EnableBuiltInNS(bool enable) {
  LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
  CHECK_INITIALIZED();
...
#if defined(WEBRTC_IOS)
int AudioDeviceModuleExternal::GetPlayoutAudioParameters(
...
int AudioDeviceModuleExternal::GetRecordAudioParameters(
    AudioParameters* params) const {
  LOG(INFO) << __FUNCTION__;
...
AudioDeviceModuleExternal::PlatformType AudioDeviceModuleExternal::Platform() const {
  LOG(INFO) << __FUNCTION__;
...
AudioDeviceModule::AudioLayer AudioDeviceModuleExternal::PlatformAudioLayer()
    const {
  LOG(INFO) << __FUNCTION__;
